namespace KnockKnockRest
{
    public class Secrets
    {
        ...
        public static readonly string ConnectionString = "Data Source=knockknockw.database.windows.net;Initial Catalog=knock;User ID=knockknockadmin;Password=pepsimax123!;Connect Timeout=60;Encrypt=True;Trust Server Certificate=False;Application Intent=ReadWrite;Multi Subnet Failover=False";
    }
}
