namespace KnockKnockRest
{
    public class Secrets
    {
        ...
        public static readonly string ConnectionString = "Data Source=knockknock96.database.windows.net;Initial Catalog=KnockKnockDb;User ID=adminknockknock;Password=pepsimax123!;Encrypt=True;TrustServerCertificate=False;ApplicationIntent=ReadWrite;MultiSubnetFailover=False";
    }
}
